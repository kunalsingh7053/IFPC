  ...
  return (
    <PageWrapper>
      <motion.section
        ...
        className="mx-auto w-full max-w-6xl rounded-3xl border border-white/10 bg-gradient-to-br from-slate-900/85 via-slate-900/75 to-cyan-950/75 p-4 shadow-[0_22px_55px_rgba(0,0,0,0.35)] sm:p-6 lg:p-8"
      >
        <div className="grid gap-4 lg:grid-cols-[0.9fr_1.1fr] lg:gap-6">
          ...
          >
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="mt-4 inline-flex rounded-xl border border-cyan-300/35 bg-cyan-500/10 px-4 py-2.5 text-sm font-semibold text-cyan-100 transition hover:bg-cyan-500/20"
            >
              Follow on Instagram
            </a>
            ...
            <form className="mt-6 space-y-4 border-t border-white/10 pt-5">
              ...
              <button className="w-full rounded-xl bg-gradient-to-r from-cyan-500 to-indigo-500 px-5 py-3 font-semibold text-white shadow-[0_12px_30px_rgba(34,211,238,0.28)] transition hover:brightness-110 sm:w-auto">
                Send Message
              </button>
            </form>
          </motion.div>
          ...
          >
            <div className="map-frame relative overflow-hidden rounded-xl border border-cyan-300/20 bg-black/30 shadow-[0_18px_45px_rgba(0,0,0,0.38)]">
            ...
            <div className="mt-3 flex flex-col gap-2 sm:flex-row">
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="inline-flex flex-1 items-center justify-center rounded-xl border border-cyan-300/30 bg-cyan-500/10 px-4 py-2.5 text-sm font-semibold text-cyan-100 transition hover:bg-cyan-500/20"
              >
                Open in Google Maps
              </a>
              <a
